...
def bulk_index_documents(docs):
    try:
        successes, errors = helpers.bulk(client, docs, chunk_size=500, request_timeout=60)
...
if __name__ == "__main__":
    ...
    sample_docs = generate_sample_documents(num_docs=10) # Generate 10 docs for this example
